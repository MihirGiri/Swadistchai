...
export default function ManageBannerOffers() {
 ...
 `${import.meta.env.VITE_API_URL}/banner-offers/admin`,
 {
 headers: {
 ...
 ? `${import.meta.env.VITE_API_URL}/banner-offers/${editingOffer._id}`
 ...
 try {
 const response = await fetch(
 `${import.meta.env.VITE_API_URL}/banner-offers/${offerId}`,
 {
 method: "DELETE",
 headers: {
 Authorization: `Bearer ${token}`,
